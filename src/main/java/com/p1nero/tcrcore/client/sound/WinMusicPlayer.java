...
public class WinMusicPlayer {
    ...
    public static void playWinMusic() {
        ...
        if (player != null && TCRSounds.WIN_BGM != null && player.isAlive()) {
            if (music != null) {
                ...
                if (canPlay()) {
                    music = new WinMusic(TCRSounds.WIN_BGM.get(), player.getRandom());
                }
            }
    ...
    public static boolean canPlay() {
        return Minecraft.getInstance().screen instanceof TCREndScreen;
    }
